...
BEGIN
	SELECT * FROM USER JOIN MECHANIC WHERE USER.USERNAME = uName;
...
BEGIN
	SELECT * FROM USER JOIN MOTORIST WHERE USER.USERNAME = uName;
...
BEGIN
	SELECT * FROM SERVICEREQUESTS WHERE USER.requestNum = rNum;
